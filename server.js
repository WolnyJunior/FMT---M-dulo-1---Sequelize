...
const routes = require('./routes/routes') //Importação do arquivo onde estão as rotas de requisição HTTP
...
class Server {
  ...
  { 
    ...
    server.use(routes)// Instância das rotas de requisição HTTP
